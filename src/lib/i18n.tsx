...
const en: Dict = {
  ...
  absent_deduction: "Absent days ({n})", half_deduction: "Half days ({n})", pending_days: "Days remaining ({n})",
  ...
  deduction_carried: "Deduction carried to next month", upcoming: "Upcoming",
...
const hi: Dict = {
  ...
  absent_deduction: "गैरहाज़िर दिन ({n})", half_deduction: "आधे दिन ({n})", pending_days: "बाकी दिन ({n})",
  ...
  deduction_carried: "कटौती अगले महीने में गई", upcoming: "आगे से",
...
const gu: Dict = {
  ...
  absent_deduction: "ગેરહાજર દિવસ ({n})", half_deduction: "અડધા દિવસ ({n})", pending_days: "બાકી દિવસ ({n})",
  ...
  deduction_carried: "કપાત આવતા મહિને ગઈ", upcoming: "આગળથી",
